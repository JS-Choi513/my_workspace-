...
**추천 시작점:** `context/target-servers.md` 작성

이유: error-handling.md 완료. 다음 문서 우선순위 순서대로 진행.

### 남은 문서 작업 (우선순위 순)

| 순서 | 문서 | 상태 |
|------|------|------|
| 1 | `context/target-servers.md` | 미작성 |
| 2 | `.claude/rules/migration.md` | 미작성 |
| 3 | `context/infra-environment.md` | 미작성 |
| 4 | 필수 시스템 설정 목록 문서 | 미작성 (E 항목에서 파생) |
